...
class ConversionCardDemographic extends React.Component {
  render() {
    return (
        <div className="col-lg-4 col-md-12">
                    <div className="card">
                        <div className="header">
                            <h2>Conversion by Ages <small>Top 5 cities in the world</small></h2>
...
export default ConversionCardDemographic
